...
## SUAS INSTRUÇÕES:
1.  **Análise de Insumos:** Leia o conteúdo do esboço (`fundamentos.pdf`) e identifique as lacunas teóricas que precisam ser preenchidas pelos "demais arquivos base".
...
3.  **Integração de Análises Extras:** O usuário solicitou análises atípicas para artigos de física pura (SWOT, PESTEL). Determine onde elas se encaixam melhor (provavelmente na Discussão ou em uma seção de "Aplicabilidade e Viabilidade Tecnológica").
